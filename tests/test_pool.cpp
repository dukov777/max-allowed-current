...
{
    auto cap1 = CapacitorFactory::create_single(1, 1000, 500, 500e3, "1uF_1000V");
    auto cap1_expected = CapacitorPtr(new Capacitor(1, 1000, 500, 500e3, "1uF_1000V"));

    auto cap2 = CapacitorFactory::create_single(1, 1000, 500, 500e3, "1uF_1000V");
    auto cap2_expected = CapacitorPtr(new Capacitor(1, 1000, 500, 500e3, "1uF_1000V"));
    ...
    double xc = parallel_cap1_values.xc(1) + parallel_cap2_values.xc(1);
    ASSERT_NEAR(series.voltage(1, 1000), xc * 1000, 1e-2);
...
{
    auto cap11 = CapacitorFactory::create_single(1, 1000, 500, 500e3, "1uF_1000V");
    auto cap11_expected = CapacitorPtr(new Capacitor(1, 1000, 500, 500e3, "1uF_1000V"));

    auto cap21 = CapacitorFactory::create_single(1, 800, 600, 500e3, "1uF_800V");
    auto cap21_expected = CapacitorPtr(new Capacitor(1, 800, 600, 500e3, "1uF_800V"));
...
TEST(Pool, Pool_TestSeriesCapacitorCornerCase2DifferentCapacitors) 
{
    ...
    auto cap21_expected = CapacitorPtr(new Capacitor(2, 800, 600, 500e3, "2uF_800V"));
    ...
    double current = 1000 / (parallel_cap1_values.xc(1) + parallel_cap2_values.xc(1));
    ASSERT_EQ(series.current(1, 1000), current);
    
    double allowed_current = std::min(parallel_cap1_values.allowed_current(1), parallel_cap2_values.allowed_current(1));
